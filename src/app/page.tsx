...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-900 via-blue-900 to-fuchsia-900 relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute w-96 h-96 -top-12 -right-12 bg-cyan-400 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob" />
        <div className="absolute w-96 h-96 -bottom-12 -left-12 bg-fuchsia-400 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000" />
        <div className="absolute w-96 h-96 top-1/2 left-1/2 bg-emerald-400 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-6">
        <div className="text-center mb-12 space-y-4">
          <div className="flex items-center justify-center mb-6">
            <Brain className="w-12 h-12 text-cyan-200 animate-pulse" />
          </div>
          ...
          <p className="text-blue-200 text-lg max-w-2xl mx-auto">
            Enhance your learning journey with interactive quizzes and flashcards. Master any
            subject at your own pace.
          </p>
        </div>

        <div className="grid md:grid-cols-2 gap-6 max-w-4xl w-full px-4">
          <Card className="group relative overflow-hidden bg-white/10 backdrop-blur-sm border-cyan-300/20 hover:border-cyan-300/40 transition-all duration-300">
            <Link href="/quiz" className="block p-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-blue-200">
                  Test your knowledge with our adaptive quizzes. Get instant feedback and track your
                  progress.
                </p>
          ...
          <Card className="group relative overflow-hidden bg-white/10 backdrop-blur-sm border-fuchsia-300/20 hover:border-fuchsia-300/40 transition-all duration-300">
            <Link href="/flashcard" className="block p-6">
              <div className="absolute top-0 right-0 p-4">
                <Sparkles className="w-6 h-6 text-emerald-300 group-hover:animate-spin" />
              </div>
              <div className="space-y-4">
                ...
                <p className="text-blue-200">
                  Create and study with AI-powered flashcards. Perfect for memorization and quick
                  reviews.
                </p>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl w-full px-4">
          {[
            ...
            <div key={index} className="text-center space-y-1">
              <div className="text-cyan-200 text-sm">{feature.title}</div>
      ...
      <CopilotPopup
        instructions={
          "You are a helpful learning assistant. Help users with any questions about studying, learning methods, educational topics, or how to use this platform. Provide thoughtful, educational responses to enhance their learning journey."
        }
        labels={{
          title: "Learning Assistant",
          initial: "Ask anything about learning",
        }}
      />
    </div>
  );
